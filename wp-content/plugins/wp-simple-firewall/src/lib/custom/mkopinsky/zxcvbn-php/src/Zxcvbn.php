...
class Zxcvbn
{
    ...
    {
        $this->matcher = new \ZxcvbnPhp56\Matcher();
        $this->scorer = new \ZxcvbnPhp56\Scorer();
        $this->timeEstimator = new \ZxcvbnPhp56\TimeEstimator();
        $this->feedback = new \ZxcvbnPhp56\Feedback();
    }
